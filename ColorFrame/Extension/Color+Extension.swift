...
extension UIColor {
    ...
    convenience init(hex: String?) {
        ...
        Scanner(string: normalizedHexString).scanHexInt64(&rgbValue)
        self.init(red:UIColorMasks.redValue(CUnsignedInt(rgbValue)), green:UIColorMasks.greenValue(CUnsignedInt(rgbValue)), blue:UIColorMasks.blueValue(CUnsignedInt(rgbValue)), alpha:UIColorMasks.alphaValue(CUnsignedInt(rgbValue)))
    }
    ...
    private static let cssToHexDictionairy: [String: String] = [
        "CLEAR": "00000000",
